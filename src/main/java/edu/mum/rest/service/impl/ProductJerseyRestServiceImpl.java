...
public class ProductJerseyRestServiceImpl implements ProductRestService {
	...
	public Product findOne(Long index) {
		RestTemplate restTemplate = remoteApi.getRestTemplate();
		return (restTemplate.exchange("http://localhost:8080/JerseyRestSecurity/rest/products/" + index, HttpMethod.GET,
	...
	public Product save(Product product) {
		...
		restTemplate.postForObject("http://localhost:8080/JerseyRestSecurity/rest/products/", httpEntity,
				Product.class);
